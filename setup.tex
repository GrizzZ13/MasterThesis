...
\sjtusetup{
  ...
  info = {%
      ...
      % 标题
      %
      zh / title           = {面向大模型推理的高性能通信库},
      en / title           = {High-Performance Communication Library for LLM Inference},
      %
      % 标题页标题
      %   可使用“\\”命令手动控制换行
      %
      ...
      % 关键词
      %
      zh / keywords        = {大模型推理系统, 高性能通信库, 无流式多处理器占用, 远程直接内存访问, CUDA 进程间通信},
      en / keywords        = {LLM Inference System, High-Performance Communication Library, Stream Multiprocessor Free, RDMA, CUDA IPC},
      %
      % 姓名
      %
      zh / author          = {王浩天},
      en / author          = {Haotian Wang},
      %
      % 学号
      %
      id              = {123037910042},
      ...
      % 指导教师
      %
      zh / supervisor      = {魏星达副教授},
      en / supervisor      = {Assoc.\ Prof.\ Xingda Wei},
      %
      % 副指导教师
      %

...
\begin{figure}[!htp]
      ...
      \bicaption{\sysname 系统整体架构}{Overall architecture of \sysname}
      \label{fig:sys-arch}
\end{figure}
...
\begin{figure}[!htp]
      ...
      \bicaption{基于分片与最大在途量的优先级调度示意图}{Illustration of priority scheduling with chunking and an outstanding limit}
...
\begin{figure}[!htp]
      ...
      \bicaption{RDMA 链路执行器示意图}{Illustration of the RDMA executor}
...
\begin{figure}[!htp]
      ...
      \bicaption{NVLink 链路执行器示意图}{Illustration of the NVLink executor}

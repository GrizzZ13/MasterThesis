...
\begin{figure}[htbp]
    ...
    \caption{RDMA P2P 场景下不同 QP 数量的有效带宽}
...
\begin{figure}[htbp]
    ...
    \caption{RDMA P2P 场景下不同消息大小的有效带宽}
...
\begin{figure}[htbp]
    ...
    \caption{NVLink P2P 场景消息大小对计算性能的影响}
...
\begin{figure}[htbp]
    ...
    \caption{RDMA P2P 场景 QP 数量对计算性能的影响}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\linewidth]{figures/relative_perf_vs_msg_size_broken_y.png}
    \caption{NCCL AllGather 对计算性能的影响}
